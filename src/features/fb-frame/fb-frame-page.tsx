...
export function FbFramePage() {
  ...
  return (
    <>
      ...
      <Dialog
        onOpenChange={(open) => !open && fb.closeFacebookPrompt()}
        open={fb.showFacebookPrompt}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Change Facebook Profile Picture?</DialogTitle>
            <DialogDescription>
              Your framed photo is downloaded. Do you want to open Facebook now
              to update your profile picture?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button onClick={fb.closeFacebookPrompt} variant="outline">
              Not now
            </Button>
            <Button onClick={fb.openFacebookProfilePage}>Open Facebook</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
